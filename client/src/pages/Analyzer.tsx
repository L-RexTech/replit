        ...
        <div className="bg-gradient-to-r from-gray-800 to-gray-700 rounded-lg shadow-xl p-8 mb-10">
          ...
          <div className="mt-8 flex justify-center md:justify-start">
            <button 
              ...
              disabled={isLoading}
              className="bg-gradient-to-r from-yellow-500 to-yellow-600 text-gray-900 font-bold px-8 py-3 rounded-lg shadow-lg hover:from-yellow-600 hover:to-yellow-700 transition duration-300 flex items-center justify-center disabled:opacity-70"
            >
